...
@Component({
  selector: 'app-home-locations-preview',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './home-locations-preview.component.html',
  styleUrls: ['./home-locations-preview.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HomeLocationsPreviewComponent {
