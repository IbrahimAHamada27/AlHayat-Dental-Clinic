...
export const INITIAL_CASES: CaseStudyItem[] = [
  {
    ...
    categoryAr: 'تقويم الأسنان',
    categoryEn: 'Orthodontics',
    summaryAr: 'خطة علاجية مخصصة لإعادة اصطفاف الأسنان العلوية والسفلية واستعادة تناسق الابتسامة ووظيفة المضغ الطبيعية.',
  ...
  },
  {
    ...
    titleEn: 'Anterior Aesthetic Restoration',
    categoryAr: 'التركيبات والتجميل',
    categoryEn: 'Cosmetic & Prosthetics',
    summaryAr: 'إعادة بناء الأسنان الأمامية بتيجان زيركون تجميلية متوافقة بيولوجياً ومطابقة للون وشفافية الأسنان الطبيعية.',
    summaryEn: 'Restoring damaged anterior teeth with natural-looking biocompatible zirconia crowns.',
  },
  {
    id: 'root-canal-case-3',
    slug: 'molar-root-canal-preservation',
    titleAr: 'إنقاذ ضرس طبيعي مصاب بالتهاب عصب متقدم',
    titleEn: 'Molar Preservation via Precision Endodontics',
    categoryAr: 'علاج الجذور وحشو العصب',
    categoryEn: 'Endodontics',
    summaryAr: 'جلسة علاج عصب دقيقة ومحكمة باستخدام التقنيات الآلية، متبوعة بحشو تجميلي مقوى للحفاظ على الضرس وتفادي خلعه.',
    summaryEn: 'Root canal therapy with automated systems, successfully preserving the natural molar.',
  },
];
