...
export const CLINIC_CONFIG: ClinicConfig = {
  ...
  workingHours: [
    {
      daysAr: 'فرع برج العرب الجديدة (متاح طوال الأسبوع)',
      daysEn: 'New Borg El Arab Branch (All Week)',
      hoursAr: '٢:٣٠ ظهراً – ٩:٣٠ مساءً',
      hoursEn: '2:30 PM – 9:30 PM',
      noteAr: 'متاح طوال الأسبوع (يومياً)',
      noteEn: 'Available daily / all week',
    },
    {
      daysAr: 'فرع برج العرب القديمة (السبت – الخميس)',
      daysEn: 'Old Borg El Arab Branch (Sat – Thu)',
      hoursAr: '٣:٣٠ عصراً – ١٠:٠٠ مساءً',
      hoursEn: '3:30 PM – 10:00 PM',
      noteAr: 'الجمعة إجازة (الطوارئ بتنسيق مسبق)',
      noteEn: 'Closed on Friday (Emergency by coordination)',
    },
  ],
  defaultSeo: {
...
export const CLINIC_LOCATIONS: ClinicLocation[] = [
  {
    ...
    addressAr: 'برج العرب الجديدة – أول شارع الجهاز',
    addressEn: 'New Borg El Arab – 1st El Gehaz St.',
    buildingDetailsAr: 'أول شارع الجهاز – أعلى صيدلية د. رشا – بجوار سيتي لاب',
    buildingDetailsEn: '1st El Gehaz St. – Above Dr. Rasha Pharmacy – Next to City Lab',
    landmarksAr: ['أول شارع الجهاز', 'أعلى صيدلية د. رشا', 'بجوار سيتي لاب'],
    landmarksEn: ['1st El Gehaz St.', 'Above Dr. Rasha Pharmacy', 'Next to City Lab'],
    directionsAr: 'يقع الفرع في أول شارع الجهاز ببرج العرب الجديدة، أعلى صيدلية د. رشا مباشرة بالدور الأول، بجوار سيتي لاب.',
    directionsEn: 'Located at the entrance of El Gehaz Street in New Borg El Arab, directly above Dr. Rasha Pharmacy on the 1st floor, next to City Lab.',
    descriptionAr: 'فرع مجهز بالكامل لتقديم رعاية متكاملة لصحة الفم والأسنان وتقويم الأسنان والتقنيات الرقمية لسكان برج العرب الجديدة (متاح طوال الأسبوع).',
    descriptionEn: 'Fully equipped branch offering comprehensive dental care, orthodontics, and digital dentistry (Available all week).',
    workingHoursAr: 'من الساعة ٢:٣٠ ظهراً حتى ٩:٣٠ مساءً',
    workingHoursEn: '2:30 PM – 9:30 PM',
    workingDaysAr: 'متاح طوال الأسبوع (يومياً)',
    workingDaysEn: 'All Week (Daily)',
    phone: '015 017 01514',
    phoneFormatted: '015 017 01514',
    whatsapp: '01501701514',
    googleMapsUrl: 'https://www.google.com/maps?q=30.885168075561523,29.582548141479492&z=17&hl=en',
    mapEmbedUrl: 'https://maps.google.com/maps?q=30.885168075561523,29.582548141479492&hl=ar&z=17&output=embed',
    services: [
      'orthodontics',
  ...
  },
  {
    ...
    buildingDetailsAr: 'شارع الوحدة الصحية – خلف مسجد التقوى – أعلى عيادة د. مؤمن',
    buildingDetailsEn: 'Health Unit St. – Behind Al-Taqwa Mosque – Above Dr. Moamen Clinic',
    landmarksAr: ['شارع الوحدة الصحية', 'خلف مسجد التقوى', 'أعلى عيادة د. مؤمن'],
    landmarksEn: ['Health Unit St.', 'Behind Al-Taqwa Mosque', 'Above Dr. Moamen Clinic'],
    directionsAr: 'يقع الفرع في شارع الوحدة الصحية ببرج العرب القديمة، خلف مسجد التقوى، أعلى عيادة د. مؤمن.',
    directionsEn: 'Located on Health Unit Street in Old Borg El Arab, behind Al-Taqwa Mosque, above Dr. Moamen Clinic.',
    ...
    workingHoursAr: 'من الساعة ٣:٣٠ عصراً حتى ١٠:٠٠ مساءً',
    workingHoursEn: '3:30 PM – 10:00 PM',
    workingDaysAr: 'السبت – الخميس (عدا الجمعة)',
    workingDaysEn: 'Saturday – Thursday (Closed Friday)',
    phone: '015 017 01514',
    phoneFormatted: '015 017 01514',
    whatsapp: '01501701514',
    googleMapsUrl: 'https://www.google.com/maps/search/%D8%B9%D9%8A%D8%A7%D8%AF%D8%A9%20%D8%A7%D9%84%D8%AD%D9%8A%D8%A7%D8%A9%20%D9%84%D8%B7%D8%A8%20%D8%A7%D9%84%D9%81%D9%85%20%D9%88%D8%A7%D9%84%D8%A3%D8%B3%D9%86%D8%A7%D9%86/@30.898292541503906,29.54408836364746,17z?hl=en',
    mapEmbedUrl: 'https://maps.google.com/maps?q=30.898292541503906,29.54408836364746&hl=ar&z=17&output=embed',
    services: [
      'orthodontics',
      'restorative-dentistry',
      'root-canal',
...
export const DOCTOR_PROFILE: Doctor = {
  ...
  education: [
    {
      degreeAr: 'بكالوريوس طب وجراحة الفم والأسنان',
      degreeEn: 'Bachelor of Dental Surgery (B.D.S.)',
      institutionAr: 'جامعة الإسكندرية',
      institutionEn: 'Alexandria University',
    },
  ],
  experience: [],
  certifications: [],
  courses: [],
  conferences: [],
  memberships: ['عضو الجمعية المصرية لزراعة الأسنان (ESOI)'],
...
export const INITIAL_TECHNOLOGY: TechnologyItem[] = [
  {
    ...
    titleAr: 'سكانر الأسنان الرقمي (Intraoral 3D Scanner)',
    titleEn: 'Digital Intraoral 3D Scanner',
    shortDescriptionAr:
      'ودّع الطرق التقليدية وخلي تشخيص وعلاج أسنانك يبدأ بتقنية أكثر دقة وراحة بدون طبعات المعجون التقليدية.',
    shortDescriptionEn:
      'Say goodbye to traditional impression trays. Modern 3D intraoral scanning provides unmatched diagnostic accuracy and patient comfort.',
    overviewAr:
      'يوفر سكانر الأسنان الرقمي تصويراً ثلاثي الأبعاد دقيقاً للاسنان بدون الطبعات والمعجون التقليدي، مما يساعد الطبيب على التخطيط المحكم للعلاج بدقة، ومناسب جداً للتقويم، التركيبات، والعديد من إجراءات الأسنان سرعة في التصوير ونتائج واضحة.',
    overviewEn:
      'The Intraoral 3D Scanner captures high-resolution digital models for orthodontic, prosthetic, and restorative treatments.',
    clinicalPurposeAr: 'تصوير 3D دقيق والتخطيط للعلاج للتقويم والتركيبات بمستويات دقة ميكروسكوبية.',
    clinicalPurposeEn: '3D digital impressions and treatment planning for braces and crowns.',
    patientBenefitAr: 'تجربة مريحة وسريعة بدون طبعات المعجون التقليدية وتصوير فوري عالي النقاء.',
    patientBenefitEn: 'Ultra-comfortable 3D scanning without gag-inducing impression pastes.',
    benefitsAr: [
      'تصوير ثلاثي الأبعاد دقيق للأسنان واللثة',
      'تجربة مريحة وسريعة بدون الطبعات والمعجون التقليدي',
      'مساعدة الطبيب على التخطيط المحكم للعلاج بدقة عالية',
      'مناسب للتقويم، التركيبات، والعديد من إجراءات الأسنان',
      'سرعة فائقة في التصوير ونتائج واضحة تظهر فورياً على الشاشة',
...
export const INITIAL_ARTICLES: ArticleItem[] = [
  {
    ...
    excerptAr: 'لو عندك واحدة أو أكتر من العلامات دي، ما تستناش المشكلة تكبر! الجير مش مجرد مشكلة في شكل الأسنان بل يهدد صحة اللثة.',
    excerptEn: 'Key warning signs indicating dental tartar accumulation and why professional cleaning is required.',
    contentAr: 'الجير مش مجرد مشكلة في شكل الأسنان؛ تراكمه ممكن يهيّج اللثة ويسبب التهابها ورائحة الفم، والجير المتصلب لا يمكن إزالته بالفرشاة العادية ويحتاج لتنظيف احترافي عند طبيب الأسنان.',
    contentEn: 'Plaque and tartar accumulation irritate gums and cause halitosis. Professional ultrasonic scaling is required.',
    categoryAr: 'تنظيف الجير',
    categoryEn: 'Tartar Scaling',
  ...
  },
  {
    ...
    excerptAr: 'بتلاحظ إن أسنانك لونها اتغير؟ أو فيه ترسبات صفراء أو بنية؟ تنظيف الأسنان الاحترافي يزيل الجير والتصبغات.',
    excerptEn: 'Learn how professional scaling removes hardened calculus and surface discoloration.',
    contentAr: 'الجير هو بلاك متصلّب، ومش بيختفي بالفرشاة العادية، ومع تراكمه ممكن يسبب التهاب ونزيف اللثة، رائحة الفم الكريهة ومشاكل بالأسنان واللثة. تنظيف الأسنان بشكل احترافي بيساعد على إزالة الجير والتصبغات السطحية.',
    contentEn: 'Professional scaling eliminates hardened plaque and surface stains to preserve healthier gums.',
    categoryAr: 'تنظيف وتلميع الأسنان',
    categoryEn: 'Scaling & Polishing',
    authorAr: 'د. معاذ سمير',
    authorEn: 'Dr. Moaz Samir',
    publishedDate: 'سبتمبر 2026',
    readTimeMinutes: 3,
